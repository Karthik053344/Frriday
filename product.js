...
function setGallery(i){
 ...
 main.classList.remove('is-ready'); main.src='';
 main.onload=()=>main.classList.add('is-ready'); main.onerror=()=>{main.classList.add('is-error');$('#galleryFallback').hidden=false;};
 main.alt=img.alt||humanTitle(product.title); main.src=img.url;
